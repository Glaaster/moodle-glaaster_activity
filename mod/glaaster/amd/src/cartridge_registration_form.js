 ...
 *
 * See template: mod_glaaster/cartridge_registration_form
 *
 * @module     mod_glaaster/cartridge_registration_form
 * @copyright  2015 Ryan Wyllie <ryan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'mod_glaaster/tool_type',
        'mod_glaaster/events',
        'mod_glaaster/keys', 'core/str'],
    function ($, ajax, notification, toolType, ltiEvents, KEYS, str) {
        ...
        var submitCartridgeURL = function () {
            ...
            promise.done(function () {
                ...
                str.get_string('failedtocreatetooltype', 'mod_glaaster').done(function (s) {
                    $(document).trigger(ltiEvents.NEW_TOOL_TYPE);
                    $(document).trigger(ltiEvents.STOP_CARTRIDGE_REGISTRATION);
                    $(document).trigger(ltiEvents.REGISTRATION_FEEDBACK, {
                        message: s,
