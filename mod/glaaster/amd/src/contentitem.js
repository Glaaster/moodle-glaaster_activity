 ...
 *
 * See template: mod_glaaster/contentitem
 *
 * @module     mod_glaaster/contentitem
    ...
    function ($, notification, str, templates, FormField, Modal, ModalEvents) {
        ...
        var contentItem = {
            ...
            init: function (url, postData, cb) {
                ...
                var bodyPromise = templates.render('mod_glaaster/contentitem', context);
                ...
                str.get_string('selectcontent', 'glaaster').then(function (title) {
                    return Modal.create({
                        title: title,
                        body: bodyPromise,
                        large: true,
        ...
        const showMultipleSummaryAndHideForm = async function (items) {
            ...
            const {html, js} = await templates.renderForPromise('mod_glaaster/tool_deeplinking_results',
                {items: items});
        ...
        /**
         * Window function that can be called from mod_glaaster/contentitem_return to close the dialogue and
