 ...
 *
 * See template: mod_glaaster/external_registration
 *
 * @module     mod_glaaster/external_registration
 * @copyright  2015 Ryan Wyllie <ryan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_glaaster/events',
        'mod_glaaster/tool_proxy', 'mod_glaaster/tool_type', 'mod_glaaster/keys', 'core/str'],
    function ($, ajax, notification, templates, ltiEvents, toolProxy, toolType, KEYS, str) {
         ...
         *
         * See mod_glaaster/tool_proxy_registration_form template.
         *
        ...
        var getRegistrationRequest = function (id) {
            var request = {
                methodname: 'mod_glaaster_get_tool_proxy_registration_request',
                args: {
                    id: id
                }
            };
        ...
        var cancelRegistration = function () {
            ...
            promise.done(function () {
                ...
                finishExternalRegistration();
                stopLoadingCancel();
                str.get_string('failedtodeletetoolproxy', 'mod_glaaster').done(function (s) {
                    var feedback = {
                        message: s,
                        error: true
                    };
        ...
        var renderExternalRegistrationWindow = function (registrationRequest) {
            var promise = templates.render('mod_glaaster/tool_proxy_registration_form', registrationRequest);
        ...
        var promptForToolTypeCapabilitiesAgreement = function (typeData) {
            ...
            templates.render('mod_glaaster/tool_type_capabilities_agree', typeData).done(function (html, js) {
        ...
        var registerEventListeners = function () {
            ...
            // parameters.
            //
            // See AMD module mod_glaaster/external_registration_return.
            window.triggerExternalRegistrationComplete = function (data) {
                ...
                if (data.status == "success") {
                    str.get_string('successfullycreatedtooltype', 'mod_glaaster').done(function (s) {
                        feedback.message = s;
                    }).fail(notification.exception);
