 ...
 *
 * @module     mod_glaaster/tool_proxy
...
define(['core/ajax', 'core/notification'], function (ajax, notification) {
    return {
        ...
        query: function (args) {
            var request = {
                methodname: 'mod_glaaster_get_tool_proxies',
                args: args || {}
            };
        ...
        'delete': function (id) {
            var request = {
                methodname: 'mod_glaaster_delete_tool_proxy',
                args: {
                    id: id
                }
            };
         ...
         *
         * See mod/glaaster/classes/external.php create_tool_proxy_parameters
         *
         * @method create
         * @public
        ...
        create: function (args) {
            var request = {
                methodname: 'mod_glaaster_create_tool_proxy',
                args: args
            };
