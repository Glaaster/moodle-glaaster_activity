...
define(['core/ajax', 'core/notification'], function (ajax, notification) {
    return {
         ...
         *
         * See also:
         * mod/glaaster/classes/external.php get_tool_types_parameters()
         *
         * @method query
         * @public
        ...
        query: function (args) {
            var request = {
                methodname: 'mod_glaaster_get_tool_types',
                args: args || {}
            };
         ...
         *
         * See also:
         * mod/glaaster/classes/external.php create_tool_type_parameters()
         *
         * @method create
         * @public
        ...
        create: function (args) {
            var request = {
                methodname: 'mod_glaaster_create_tool_type',
                args: args
            };
         ...
         *
         * See also:
         * mod/glaaster/classes/external.php update_tool_type_parameters()
         *
         * @method update
         * @public
         * @param {Object} args Tool type properties
        ...
        update: function (args) {
            var request = {
                methodname: 'mod_glaaster_update_tool_type',
                args: args
            };
        ...
        isCartridge: function (url) {
            var request = {
                methodname: 'mod_glaaster_is_cartridge',
                args: {
                    url: url
                }
            };
