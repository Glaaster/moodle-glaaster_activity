 ...
 *
 * @module     mod_glaaster/tool_types_and_proxies
 ...
 *
 * See also:
 * mod/glaaster/classes/external.php get_tool_types_and_proxies()
 *
 * @method query
 * @public
...
export const query = (args) => {
    const request = {
        methodname: 'mod_glaaster_get_tool_types_and_proxies',
        args: args || {}
    };
 ...
 *
 * See also:
 * mod/glaaster/classes/external.php get_tool_types_and_proxies_count()
 *
 * @method count
 * @public
 * @param {Object} args Search parameters
...
export const count = (args) => {
    const request = {
        methodname: 'mod_glaaster_get_tool_types_and_proxies_count',
        args: args || {}
    };
