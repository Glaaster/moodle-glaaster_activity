...
class toggle_showinactivitychooser extends external_api {
     ...
     * @param bool $showinactivitychoos Show in activity chooser setting.
     * @return bool true or false
     */
    public static function execute(int $tooltypeid, int $courseid, bool $showinactivitychoos): bool {
        [
            'tooltypeid' => $tooltypeid,
            'courseid' => $courseid,
            'showinactivitychooser' => $showinactivitychoos,
        ...
        return types_helper::override_type_showinactivitychooser(
            $tooltypeid,
            $courseid,
            $context,
            $showinactivitychoos
