 ...
 * Helper class for LTI activity.
 *
 * This class provides methods to help with LTI tool proxy management.
 *
 * @package    mod_glaaster
 */
class helper {
     ...
     * @return string SQL.
     */
    public static function glaaster_get_tool_proxy_sql(bool $orphanedonly = false, bool $count = false): string {
        if ($count) {
