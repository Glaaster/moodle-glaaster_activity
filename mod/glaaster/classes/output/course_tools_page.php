...
use context_course;
use mod_glaaster\output\course_tools_page_header;
use core_reportbuilder\system_report_factory;
use mod_glaaster\reportbuilder\local\systemreports\course_external_tools_list;
use renderable;
...
class course_tools_page implements renderable {
    ...
    /** @var \mod_glaaster\output\course_tools_page_header the page header renderable instance. */
    ...
    public function __construct(int $courseid) {
        ...
        $canadd = has_capability('mod/glaaster:addcoursetool', $context);
        $sql = 'SELECT COUNT(1)
                  FROM {glaaster_types} tt
     ...
     *
     * @return \mod_glaaster\output\course_tools_page_header the renderable.
     */
