...
use mod_glaaster\output\course_tools_page;
...
class renderer extends plugin_renderer_base {
    ...
    public function render_tool_configure_page($page) {
        ...
        return parent::render_from_template('mod_glaaster/tool_configure', $data);
    }
    ...
    public function render_external_registration_return_page($page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('mod_glaaster/external_registration_return', $data);
    }
    ...
    public function render_registration_upgrade_choice_page($page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('mod_glaaster/registration_upgrade_choice_page', $data);
    }

    /**
     * Render the reposting of the cross site request.
     *
     * @param \mod_glaaster\output\repost_crosssite_page $page the page renderable.
     *
     * @return string rendered html for the page.
     */
    public function render_repost_crosssite_page(repost_crosssite_page $page): string {
        $data = $page->export_for_template($this);
        return parent::render_from_template('mod_glaaster/repost_crosssite', $data);
    }
    ...
    protected function render_course_tools_page(course_tools_page $page): string {
        ...
        $headeroutput = parent::render_from_template('mod_glaaster/course_tools_page_header', $headercontext);
