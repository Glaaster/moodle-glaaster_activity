...
$pageurl = new moodle_url('/mod/glaaster/contentitem_return.php');
...
$PAGE->requires->js_call_amd('mod_glaaster/contentitem_return', 'init', [$returndata]);
...
if ($errormsg) {
    ...
    // Means success.
    if (!$msg) {
        $msg = get_string('successfullyfetchedtoolconfigurationfromcontent', 'glaaster');
    }
