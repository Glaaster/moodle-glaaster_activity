...
$string['apisetup_desc'] = 'Follow the steps below to configure the Glaaster API connection.';

// Step 1 – Create dedicated user.
$string['apistep_createuser'] = 'Step 1 — Create a dedicated user';
$string['apistep_createuser_help_title'] = 'Why create a dedicated user?';
$string['apistep_createuser_help'] = 'Glaaster needs a dedicated Moodle account to authenticate its webservice calls. This account acts as a service account — it is never used to log in as a real person.<br><br>To create it, go to <strong>Site Administration &gt; Users &gt; Accounts &gt; Add a new user</strong> and fill in:<br><br><strong>Username:</strong> glaasterapi<br><strong>First name:</strong> Glaaster<br><strong>Last name:</strong> API<br><strong>Email:</strong> system@glaaster.com<br><br>⚠️ Keep this account active — it is required for the Glaaster API to work.';
$string['apistep_createuser_desc'] = 'Create a dedicated Moodle account that Glaaster will use to authenticate its API calls. This account should never be used to log in as a real person.';

// Step 2 – Assign user.
$string['apistep_assignuser'] = 'Step 2 — Assign the API user';
$string['apistep_assignuser_help_title'] = 'What happens when you assign this user?';
$string['apistep_assignuser_help'] = 'When you save the selected user, Moodle will automatically:<br><br>• Grant the <strong>Glaaster API role</strong> (<code>glaasterapi</code>) to this user at system level — this role gives the minimal permissions needed to respond to Glaaster requests.<br>• Add the user to the <strong>Glaaster API web service</strong> (<code>glaaster_api</code>) — this authorises the user to call the Moodle web service functions exposed to Glaaster.<br><br>You do not need to do anything else — both assignments happen automatically.';
$string['apistep_assignuser_desc'] = 'Select the dedicated user you just created. The Glaaster API role and the Glaaster web service will be assigned to this user automatically.';
...
$string['apistep_notify_btn'] = 'Notify Glaaster by email';
$string['apistep_notify_subject'] = 'Glaaster connection activated — {$a}';
$string['apistep_notify_body'] = 'Hello,

The Glaaster LTI connection has been successfully activated on the following Moodle instance:

  Moodle URL: {$a}

Could you please validate and activate the connection on your side?

Thank you.';
$string['apistep_token_help_title'] = 'What is this token for?';
$string['apistep_token_help'] = 'The API token is a secret key that identifies the Glaaster API user to Moodle.<br><br>When you click <strong>Connect to Glaaster</strong> in the next step, this token is sent automatically to the Glaaster platform. Glaaster stores it securely and uses it on every request to the Moodle web service to retrieve course documents and resources.<br><br>⚠️ Keep this token confidential — anyone who holds it can query your Moodle web service on behalf of the API user.';
$string['apistep_token_desc'] = 'Generate a permanent token for the API user. This token will be sent automatically to Glaaster when you connect, so that Glaaster can retrieve documents from your Moodle.';
...
$string['apiuser_notfound'] = 'User not found.';
$string['apistatus'] = 'Configuration status';
$string['apistatus_role'] = 'Role "Glaaster API" (glaasterapi)';
$string['apistatus_role_help_title'] = 'About the Glaaster API role';
$string['apistatus_role_help'] = 'The <strong>glaasterapi</strong> role is created automatically when the plugin is installed. It grants the minimal Moodle permissions needed for Glaaster to query webservice functions.<br><br>This role is assigned automatically to the API user when you complete Step 2.';
$string['apistatus_service'] = 'Service "Glaaster API" (glaaster_api)';
$string['apistatus_service_help_title'] = 'About the Glaaster API web service';
$string['apistatus_service_help'] = 'The <strong>glaaster_api</strong> web service is created automatically when the plugin is installed. It exposes the Moodle functions that Glaaster needs to retrieve course documents and resources.<br><br>The API user is added to this service automatically when you complete Step 2.';
$string['apistatus_user'] = 'API user assigned';
$string['apistatus_user_help_title'] = 'About the API user';
$string['apistatus_user_help'] = 'The API user is the dedicated Moodle account that Glaaster uses to authenticate its requests. It must be created manually (Step 1) and then assigned here (Step 2).<br><br>When assigned, it receives the glaasterapi role and is added to the glaaster_api web service automatically.';
$string['apistatus_ok'] = 'Ready';
$string['apistatus_missing'] = 'Not configured';
$string['apistatus_token'] = 'API token for webservice';
$string['apistatus_token_help_title'] = 'About the API token';
$string['apistatus_token_help'] = 'The API token is a permanent secret key tied to the API user. It is generated in Step 3 and sent automatically to Glaaster when you click Connect.<br><br>Glaaster uses this token on every request to the Moodle web service to retrieve documents and resources from your courses.';
$string['apitoken_label'] = 'API Token';
$string['apitoken_reveal'] = 'Show';
$string['apitoken_copy'] = 'Copy';
$string['apitoken_generate'] = 'Generate API Token';
$string['apitoken_created'] = 'API token created successfully.';
$string['apitoken_nouser'] = 'No API user configured. Please assign an API user first.';
$string['setup_welcome'] = 'Welcome! Please complete the Glaaster configuration below: set the Tool domain, assign an API user, and generate the API token.';
...
$string['connect_glaaster'] = 'Connect';
$string['connect_glaaster_desc'] = 'Register this Moodle instance with the Glaaster platform via LTI 1.3. Before connecting, you must create a dedicated Moodle user for the Glaaster API (see the API Setup section above), assign it the Glaaster API role, and generate its API token. This user authenticates all webservice calls made by Glaaster.';
$string['connect_requires_user'] = 'An API user must be assigned and a token generated before you can connect.';
$string['connect_requires_token'] = 'An API token must be generated before you can connect.';
...
$string['clientidadmin_help'] =
    'The client ID is a unique value used to identify a tool. It is created automatically for each tool which uses the JWT security profile introduced in LTI 1.3 and should be part of the details passed to the tool provider so that they can configure the connection at their end.';
...
$string['contentitem_deeplinking_help'] =
    'If ticked, the option \'Select content\' will be available when adding an external tool.';
...
$string['courseexternaltools'] = 'LTI External tools Glaaster';
$string['courseexternaltoolsinfo'] =
    'LTI External tools are add-on apps you can integrate into your course, such as interactive content or assessments. Your students can access and use them without leaving your course.';
...
$string['deletecoursetoolwithusageconfirm'] =
    '{$a} is currently being used in at least one activity in your course. If you delete this tool, the activities that use it will no longer work.<br><br>Are you sure you want to delete {$a}?';
$string['display_description'] = 'Display activity description when students access the tool';
$string['display_description_help'] =
    'Content from this tool is displayed embedded in a page in the course. This setting determines if the activity description is shown in that page.';
$string['display_name'] = 'Display activity name when students access the tool';
$string['display_name_help'] =
    'Content from this tool is displayed embedded in a page in the course. This setting determines if the activity name is shown in that page.';
...
$string['dynreg_update_warn_dupdomain'] =
    'It is not recommended to have multiple external tools under the same domain.';
...
$string['enableemailnotification_help'] =
    'If enabled, students will receive email notification when their tool submissions are graded.';
...
$string['failedtodeletetoolproxy'] =
...
$string['indicator:cognitivedepth_help'] =
    'This indicator is based on the cognitive depth reached by the student in an LTI activity.';
$string['indicator:cognitivedepthdef'] = 'LTI cognitive';
$string['indicator:cognitivedepthdef_help'] =
    'The participant has reached this percentage of the cognitive engagement offered by the LTI activities during this analysis interval (Levels = No view, View, Submit, View feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'LTI social';
$string['indicator:socialbreadth_help'] =
    'This indicator is based on the social breadth reached by the student in an LTI activity.';
$string['indicator:socialbreadthdef'] = 'LTI social';
$string['indicator:socialbreadthdef_help'] =
    'The participant has reached this percentage of the social engagement offered by the LTI activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['initiatelogin'] = 'Initiate login URL';
$string['initiatelogin_help'] =
...
$string['glaaster'] = 'LTI';
$string['glaaster:addcoursetool'] = 'Add course-specific tool configurations';
$string['glaaster:addmanualinstanceprohibitederror'] =
    'The manual creation of tools without a course tool definition is no longer supported. Please create a course tool first and then use that to create activity instances.';
$string['glaaster:addinstance'] = 'Add a new external tool';
$string['glaaster:addpreconfiguredinstance'] = 'Add a preconfigured tool';
$string['glaaster:manage'] = 'Be an Instructor when the tool is launched';
$string['glaaster:admin'] = 'Be an administrator when the tool is launched';
$string['glaaster:requesttooladd'] = 'Request a tool is configured site-wide';
$string['glaaster:view'] = 'Launch external tool activities';
...
$string['ltiversion_help'] =
    'The version of LTI being used for signing messages and service requests: LTI 1.0/1.1 and LTI 2.0 use the OAuth 1.0A security profile; LTI 1.3.0 uses JWTs.';
...
$string['modulename_link'] = 'mod/glaaster/view';
$string['modulename_shortcut_link'] = 'mod/glaaster/view/custom';
$string['modulenameplural'] = 'External tools Glaaster';
$string['modulenamepluralformatted'] = 'External tools Glaaster';
$string['name'] = 'Name';
$string['never'] = 'Never';
...
$string['organizationid_default_help'] =
    'The default value to use for Organisation ID. Site ID identifies this installation of Moodle.';
...
$string['privacy:metadata:externalpurpose'] =
    'The LTI Consumer provides user information and context to the LTI Tool Provider.';
...
$string['publickeyset_help'] =
    'Public keyset from where this site will retrieve the tool\'s public key to allow signatures of incoming messages and service requests to be verified.';
$string['publickey_help'] =
    'The public key (in PEM format) provided by the tool to allow signatures of incoming messages and service requests to be verified.';
...
$string['register_warning'] =
    'The registration page seems to be taking a while to open. If it does not appear, check that you entered the correct URL in the configuration settings. If Moodle is using https, ensure the tool you are configuring supports https and you are using https in the URL.';
...
$string['registrationurl_help'] =
    'The registration URL should be available from the tool provider as the location to which registration requests should be sent.';
...
$string['restricttocategory_help'] =
    'To restrict use of this tool to courses within a category, select the category or categories from the list.';
...
$string['secure_icon_url_help'] =
    'Similar to the icon URL, but used when the site is accessed securely through SSL. This field is to prevent the browser from displaying a warning about an insecure image.';
...
$string['services_help'] =
    'Select those services which you wish to offer to the tool provider.  More than one service can be selected.';
...
$string['share_roster_admin_help'] =
    'Specify whether the tool can access the list of users enrolled in courses from which this tool is launched.';
...
$string['show_in_course_lti1_help'] =
    'This tool may be shown in the activity chooser for a teacher to select to add to a course. Alternatively, it may be shown in the preconfigured tool drop-down menu when adding an external tool to a course. A further option is for the tool configuration to only be used if the exact tool URL is entered when adding an external tool to a course.';
$string['show_in_course_lti2'] = 'Tool configuration usage';
$string['show_in_course_lti2_help'] =
    'This tool can be shown in the activity chooser for a teacher to select to add to a course or in the preconfigured tool drop-down menu when adding an external tool to a course.';
...
$string['successfullyfetchedtoolconfigurationfromcontent'] =
    'Successfully fetched tool configuration from the selected content.';
$string['subplugintype_ltiglaasterresource'] = 'LTI service resource';
$string['subplugintype_ltiglaasterresource_plural'] = 'LTI service resources';
$string['subplugintype_ltiglaasterservice'] = 'LTI service';
$string['subplugintype_ltiglaasterservice_plural'] = 'LTI services';
$string['subplugintype_ltiglaastersource'] = 'LTI source';
$string['subplugintype_ltiglaastersource_plural'] = 'LTI sources';
...
$string['tooltypenotfounderror'] =
    "The LTI tool used in this activity has been deleted. If you need help, contact your teacher or site administrator.";
...
$string['toolurl_contentitemselectionrequest_help'] =
...
$string['typename_help'] =
    'The tool name is used to identify the tool provider within Moodle. The name entered will be visible to teachers when adding external tools within courses.';
$string['types'] = 'Types';
...
$string['glaaster:addmanualinstance'] = 'Add a manually-configured tool';
...
$string['forced_help'] =
    'This setting has been forced in a course or site level tool configuration. You may not change it from this interface.';

// Deprecated since Moodle 4.5.
$string['selectcontentvalidationerror'] = 'You need to select content for this activity.';

$string['view_document_adaptive'] = 'View document in an adapted way';

// Glaaster configuration settings.
$string['generalsettings'] = 'General configuration';
