...
$string['capabilities_help'] =
    'Veuillez sélectionner les capacités que vous désirez offrir au fournisseur de l’outil. Il est possible de sélectionner plusieurs capacités.';
...
$string['contentitem_deeplinking_help'] =
    'Si ce réglage est activé, l’option « Sélectionner un contenu » sera disponible lors de l’ajout d’un outil externe.';
...
$string['courseexternaltools'] = 'Outils externes LTI Glaaster';
$string['courseexternaltoolsinfo'] =
    'Les outils externes LTI sont des apps tierces que l’on peut ajouter à un cours, par exemple des contenus interactifs ou des évaluations. Les étudiants peuvent y accéder et les utiliser sans quitter le cours.';
...
$string['deletecoursetoolwithusageconfirm'] =
    '{$a} est actuellement utilisé dans au moins une activité de votre cours. Si cet outil est supprimé, les activités qui l’utilisent ne fonctionneront plus.<br><br>Voulez-vous vraiment supprimer {$a} ?';
...
$string['display_description_help'] =
    'Le contenu de cet outil est affiché dans une page dans le cours. Ce réglage détermine si la description de l’activité est affichée dans cette page.';
$string['display_name'] = 'Afficher le nom de l’activité lorsque des étudiants accèdent à l’outil';
$string['display_name_help'] =
    'Le contenu de cet outil est affiché dans une page dans le cours. Ce réglage détermine si le nom de l’activité est affiché dans cette page.';
...
$string['dynreg_update_text'] =
    'Des outils existants sont liés au domaine d’enregistrement. Voulez-vous vraiment mettre à jour un outil externe déjà installé ou voulez-vous créer un nouvel outil externe ?';
$string['dynreg_update_url'] = 'URL de base';
$string['dynreg_update_version'] = 'Version LTI';
$string['dynreg_update_warn_dupdomain'] =
    'Il n’est pas recommandé d’avoir plusieurs outils externes sous le même domaine.';
...
$string['enableemailnotification_help'] =
    'Si ce réglage est activé, les participants recevront notification par courriel lorsque leur remise est évaluée.';
...
$string['errormisconfig'] =
    'Outil mal configuré. Veuillez demander à l’administrateur de votre Moodle de corriger sa configuration.';
...
$string['failedtodeletetoolproxy'] =
    'Échec de suppression de l’enregistrement de l’outil. Veuillez aller à la gestion des enregistrements des outils externes et le supprimer manuellement.';
...
$string['forced_help'] =
    'Ce réglage a été imposé au niveau de la configuration du cours ou du site. Vous ne pouvez pas le modifier depuis cette interface.';
...
$string['icon_url_help'] =
    'L’URL de l’icône permet de spécifier une icône différente à afficher pour cette activité dans la liste du cours. Au lieu d’afficher l’icône LTI par défaut, on peut spécifier une icône qui représente mieux le type de l’activité.';
$string['id'] = 'ID';
$string['indicator:cognitivedepth'] = 'LTI : aspect cognitif';
$string['indicator:cognitivedepth_help'] =
    'Cet indicateur est basé sur la profondeur cognitive atteinte par l’étudiant dans une activité LTI.';
$string['indicator:cognitivedepthdef'] = 'LTI : aspect cognitif';
$string['indicator:cognitivedepthdef_help'] =
    'Le participant a atteint durant cet intervalle d’analyse ce pourcentage d’engagement cognitif offert par les activités « LTI » (niveaux : pas de vue, vue, envoi, vue du feedback).';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'LTI : aspect social';
$string['indicator:socialbreadth_help'] =
    'Cet indicateur se base sur l’interaction sociale atteinte par l’étudiant dans une activité LTI.';
$string['indicator:socialbreadthdef'] = 'LTI : aspect social';
$string['indicator:socialbreadthdef_help'] =
    'Le participant a atteint durant cet intervalle d’analyse ce pourcentage d’engagement social offert par les activités « LTI » (niveaux : pas de participation, participant seul, participant avec d’autres).';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['initiatelogin'] = 'URL d’initiation de connexion';
$string['initiatelogin_help'] =
    'L’URL de l’outil à laquelle sont envoyées les requêtes d’initiation de connexion. Cette URL est nécessaire avant qu’un message puisse être envoyé correctement à l’outil.';
...
$string['glaaster'] = 'LTI Glaaster';
$string['glaaster:addcoursetool'] = 'Ajouter des configurations d’outils externes Glaaster propres à un cours';
$string['glaaster:addinstance'] = 'Ajouter un outil externe Glaaster';
$string['glaaster:addmanualinstance'] = 'Ajouter un outil configuré manuellement';
$string['glaaster:addmanualinstanceprohibitederror'] =
    'La création manuelles d’outils Glaaster sans définition d’un outil de cours n’est plus prise en charge. Veuillez d’abord créer un outil de cours, plus utilisez-le pour créer des instances d’activité.';
$string['glaaster:addpreconfiguredinstance'] = 'Ajouter un outil préconfiguré';
$string['glaaster:admin'] = 'Devenir un administrateur lorsque l’outil est lancé';
$string['glaaster:manage'] = 'Être formateur lorsqu’un outil externe est lancé';
$string['glaaster:requesttooladd'] = 'Demander la configuration d’outils externes pour tout le site';
$string['glaaster:view'] = 'Lancer des activités d’outils externes Glaaster';
...
$string['lti_launch_error_tool_request'] =
    '<p>Pour demander à un administrateur de terminer la configuration de cet outil, cliquez <a href="{$a->admin_request_url}" target="_top">ici</a>.</p>';
...
$string['lti_tool_request_added'] =
    'La demande de configuration a été envoyée correctement. Vous pouvez contacter un administrateur pour terminer la configuration de l’outil.';
...
$string['ltiversion_help'] =
    'La version de LTI utilisée pour signer les messages et les requêtes de service : LTI 1.0/1.1 et LTI 2.0 utilisent le profil de sécurité OAuth 1.0A ; LTI 1.3.0 utilise JWT.';
...
$string['modulenameplural'] = 'Outils externes Glaaster';
$string['modulenamepluralformatted'] = 'Outils externes Glaaster';
$string['name'] = 'Nom';
$string['never'] = 'Jamais';
...
$string['notypes'] =
    'Il n’y a actuellement dans Moodle aucune configuration d’outil LTI. Cliquer sur le lien d’installation ci-dessus pour en ajouter.';
...
$string['opensslconfiginvalid'] =
    'LTI 1.3 nécessite la configuration d’un fichier openssl.cnf valide et pouvant être atteint par votre serveur web. Veuillez contacter l’administrateur du site pour configurer et activer openssl pour ce site.';
...
$string['organizationid_default_help'] =
    'La valeur à utiliser par défaut pour l’ID de l’institution. L’ID du site identifie cette installation de Moodle.';
$string['organizationidguid'] = 'ID de l’institution';
$string['organizationidguid_help'] =
    'Un identifiant unique pour cette instance de Moodle, envoyé à l’outil comme « Platform Instance GUID ».';
...
$string['parameter_help'] =
    'Les paramètres d’outil sont des réglages devant être fournis au proxy de l’outil accepté par le fournisseur de l’outil.';
...
$string['privacy:metadata:coursefullname'] =
    'Le nom complet du cours depuis lequel l’utilisateur accède au contenu LTI';
...
$string['privacy:metadata:courseshortname'] =
    'Le nom abrégé du cours depuis lequel l’utilisateur accède au contenu LTI';
...
$string['privacy:metadata:externalpurpose'] =
    'Le contenu LTI fournit des informations utilisateur et le contexte vers le fournisseur de l’outil LTI.';
...
$string['publickey_help'] =
    'La clef publique (en format PEM) fournie par l’outil pour permettre la signature des messages entrant et la vérification des requêtes de service.';
$string['publickeyset'] = 'Jeu de clefs public';
$string['publickeyset_help'] =
    'Le jeu de clefs public dans lequel ce site récupérera la clef publique de l’outil pour permettre la vérification de la signature des messages entrants et des requêtes de service.';
...
$string['redirectionuris_help'] =
    'Une liste d’URIs (un par ligne) que l’outil utilise lorsqu’il effectue les requêtes d’autorisations. Au moins un URI doit être enregistré avant qu’un message puisse être envoyé correctement à l’outil.';
$string['register'] = 'Enregistrer';
$string['register_warning'] =
    'La page d’enregistrement prend trop de temps à ouvrir. Si elle ne s’ouvre pas, veuillez vérifier que l’URL saisie dans la configuration est correcte. Si Moodle utilise https, assurez-vous que l’outil que vous configurez prenne en charge https et que vous avez bien indiqué https dans l’URL.';
...
$string['registrationurl_help'] =
    'L’URL d’enregistrement doit être mise à disposition par le fournisseur de l’outil pour désigner où les demandes d’enregistrement doivent être envoyées.';
...
$string['restricttocategory_help'] =
    'Pour restreindre l’utilisation de cet outil aux cours d’une catégorie, sélectionner une ou des catégories de la liste.';
...
$string['secure_icon_url_help'] =
    'Analogue à l’URL de l’icône, mais utilisée lorsque le participant accède à Moodle au moyen du protocole sécurisé SSL. Ce champ permet d’éviter que le navigateur affiche un avertissement sur une image non sécurisée.';
...
$string['services_help'] =
    'Sélectionnez les services que vous désirez offrir au fournisseur de l’outil. Plusieurs services peuvent être sélectionnés.';
...
$string['share_roster_admin_help'] =
    'Indiquez si cet outil peut accéder à la liste des utilisateurs inscrits aux cours à partir desquels cet outil est lancé.';
...
$string['subplugintype_ltiglaasterresource'] = 'Ressource de service LTI';
$string['subplugintype_ltiglaasterresource_plural'] = 'Ressources de service LTI';
$string['subplugintype_ltiglaasterservice'] = 'Service LTI';
$string['subplugintype_ltiglaasterservice_plural'] = 'Services LTI';
$string['subplugintype_ltiglaastersource'] = 'Source LTI';
$string['subplugintype_ltiglaastersource_plural'] = 'Sources LTI';
$string['successfullycreatedtooltype'] = 'Nouvel outil créé !';
$string['successfullyfetchedtoolconfigurationfromcontent'] =
    'La configuration de l’outil a été récupérée correctement à partir du contenu sélectionné.';
...
$string['tooltypenotfounderror'] =
    'L’outil LTI utilisé dans cette activité a été supprimé. Si vous avez besoin d’assistance, contactez votre enseignant ou l’administrateur du site.';
...
$string['toolurl_contentitemselectionrequest_help'] =
    'L’URL de sélection de contenu sera utilisée pour ouvrir la page de sélection de contenu du fournisseur de l’outil. Si elle est laissée vide, l’URL de l’outil sera utilisée';
...
$string['typename_help'] =
    'Le nom de l’outil est utilisé pour identifier le fournisseur de l’outil dans Moodle. Le nom saisi sera visible pour les enseignants lors de l’ajout d’outils externes dans leurs cours.';
$string['types'] = 'Types';
...
$string['view_document_adaptive'] = 'Voir le document de manière adaptée';

// Paramètres de configuration Glaaster.
$string['generalsettings'] = 'Configuration générale';
...
$string['apiuser_help'] = 'Cet utilisateur sera utilisé pour authentifier les appels webservice de Glaaster. Pour créer un utilisateur dédié, accédez à Administration du site > Utilisateurs > Comptes > Ajouter un nouvel utilisateur et renseignez les informations suivantes :<br><br><strong>Nom d\'utilisateur :</strong> glaasterapi<br><strong>Prénom :</strong> Glaaster<br><strong>Nom :</strong> API<br><strong>Adresse de courriel :</strong> system@glaaster.com<br><br>⚠️ Conservez bien cet utilisateur, il sera nécessaire pour la configuration de l\'administration Glaaster.';
$string['apiuser_current'] = 'Utilisateur API actuel : {$a}';
$string['apiuser_none'] = 'Aucun utilisateur API configuré.';
$string['apiuser_saved'] = 'Utilisateur API enregistré avec succès.';
...
$string['apitoken_generate'] = 'Générer le token API';
$string['apitoken_created'] = 'Token API créé avec succès.';
$string['apitoken_nouser'] = 'Aucun utilisateur API configuré. Veuillez d\'abord assigner un utilisateur API.';
$string['setup_welcome'] = 'Bienvenue ! Veuillez compléter la configuration Glaaster ci-dessous : renseignez le domaine de l\'outil, assignez un utilisateur API et générez le token API.';
$string['connect_glaaster'] = 'Connecter';
$string['connect_glaaster_desc'] = 'Enregistrez cette instance Moodle auprès de la plateforme Glaaster via LTI 1.3. Avant de connecter, vous devez créer un utilisateur Moodle dédié pour l\'API Glaaster (voir la section Configuration API ci-dessous), lui attribuer le rôle API Glaaster et générer son token API. Cet utilisateur authentifie tous les appels webservice effectués par Glaaster.';
$string['connect_requires_user'] = 'Un utilisateur API doit être assigné et un token généré avant de pouvoir connecter.';
$string['connect_requires_token'] = 'Un token API doit être généré avant de pouvoir connecter.';
$string['connect_status_pending'] = 'En cours de validation';
