...
$conf = [
    'issuer' => $CFG->wwwroot,
    'token_endpoint' => (new moodle_url('/mod/glaaster/token.php'))->out(false),
    'token_endpoint_auth_methods_supported' => ['private_key_jwt'],
    'token_endpoint_auth_signing_alg_values_supported' => ['RS256'],
    'jwks_uri' => (new moodle_url('/mod/glaaster/certs.php'))->out(false),
    'authorization_endpoint' => (new moodle_url('/mod/glaaster/auth.php'))->out(false),
    'registration_endpoint' => (new moodle_url('/mod/glaaster/openid-registration.php'))->out(false),
