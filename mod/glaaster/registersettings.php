...
require_once($CFG->dirroot . '/mod/glaaster/register_form.php');
...
$isupdate = !empty($id);
$pageurl = new moodle_url('/mod/glaaster/registersettings.php');
if ($isupdate) {
    $pageurl->param('id', $id);
}
if (!empty($returnto)) {
...
$form = new mod_glaaster_register_types_form($pageurl, (object) $data);
...
if ($form->is_cancelled()) {
    ...
    $PAGE->navbar->add(get_string('lti_administration', 'glaaster'), $redirect);
