 ...
 *
 * @package    ltiglaasterservice_profile
 * @copyright  2014 Vital Source Technologies http://vitalsource.com
 * @author     Stephen Vickers
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace ltiglaasterservice_profile\local\resources;
...
class profile extends resource_base {
    ...
    public function execute($response) {
        ...
        if ($ok) {
            ...
            $serviceoffered = '';
            $sep = '';
            $services = core_component::get_plugin_list('ltiglaasterservice');
...
EOD;
            ...
            if (!empty($CFG->mod_glaaster_institution_name)) {
                $consumername = $CFG->mod_glaaster_institution_name;
                $consumerdesc = '';
            } else {
