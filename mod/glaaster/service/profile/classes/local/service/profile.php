...
namespace ltiglaasterservice_profile\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class profile extends service_base {
    /**
     * Class constructor.
     */
    ...
    public function get_resources() {
        if (empty($this->resources)) {
            $this->resources = [];
            $this->resources[] = new \ltiglaasterservice_profile\local\resources\profile($this);
        }
