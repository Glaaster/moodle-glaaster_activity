 ...
 *
 * @package    ltiglaasterservice_toolsettings
 * @copyright  2014 Vital Source Technologies http://vitalsource.com
 * @author     Stephen Vickers
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace ltiglaasterservice_toolsettings\local\service;

use ltiglaasterservice_toolsettings\local\resources\contextsettings;
use ltiglaasterservice_toolsettings\local\resources\linksettings;
use ltiglaasterservice_toolsettings\local\resources\systemsettings;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class toolsettings extends service_base {
    ...
    public static function distinct_settings(&$systemsettings, &$contextsettings, $linksettings) {
        if (!empty($systemsettings)) {
            foreach ($systemsettings as $key => $value) {
                if (
                    (!empty($contextsettings) && array_key_exists($key, $contextsettings)) ||
    ...
    public function get_resources() {
        if (empty($this->resources)) {
            $this->resources = [];
            $this->resources[] = new systemsettings($this);
            $this->resources[] = new contextsettings($this);
            $this->resources[] = new linksettings($this);
        }
