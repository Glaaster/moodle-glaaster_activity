...
$isget = $response->get_request_method() === mod_glaaster\local\ltiglaasterservice\resource_base::HTTP_GET;
$isdelete = $response->get_request_method() === mod_glaaster\local\ltiglaasterservice\resource_base::HTTP_DELETE;
