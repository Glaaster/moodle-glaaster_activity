@mod @mod_glaaster @core_backup @javascript
Feature: Glaaster - Restoring Moodle 2 backup restores LTI configuration
  ...
  Scenario: Backup and restore course with preconfigured site LTI tool on the same site
    ...
    And the following "mod_glaaster > tool instances" exist:
      | name          | tool         | course |
