@mod @mod_glaaster
Feature: Glaaster - Make an LTI only available to specific course categories
  ...
  Background:
    ...
    And the following "mod_glaaster > tool types" exist:
      | name            | description        | baseurl                                        | coursevisible | state | lti_coursecategories |
      | Teaching Tool 1 | Tool 1 description | /mod/glaaster/tests/fixtures/tool_provider.php | 1             | 1     | catb                 |
      | Teaching Tool 2 | Tool 2 description | /mod/glaaster/tests/fixtures/tool_provider.php | 2             | 1     | catca                |
  ...
  # Step 2 - Unselect child but parent should stay as selected.
    ...
    And I set the field "Tool URL" to local url "/mod/glaaster/tests/fixtures/tool_provider.php"
