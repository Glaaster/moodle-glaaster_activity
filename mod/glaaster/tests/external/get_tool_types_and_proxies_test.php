 ...
 */
final class get_tool_types_and_proxies_test extends mod_glaaster_testcase {
    /**
     ...
     */
    public function test_mod_glaaster_get_tool_types_and_proxies(): void {
     ...
     */
    public function test_mod_glaaster_get_tool_types_and_proxies_with_multiple_pages(): void {
        for ($i = 0; $i < 3; $i++) {
     ...
     */
    public function test_mod_glaaster_get_tool_types_and_proxies_with_multiple_pages_last_page(): void {
        for ($i = 0; $i < 6; $i++) {
            $proxy = $this->generate_tool_proxy($i);
            $this->generate_tool_type($i, $proxy->id);
        }
     ...
     */
    public function test_mod_glaaster_get_tool_types_and_proxies_without_pagination(): void {
        for ($i = 0; $i < 10; $i++) {
            $proxy = $this->generate_tool_proxy($i);
            $this->generate_tool_type($i, $proxy->id);
        }
