...
/**
 * Define behat generator for mod_glaaster.
 *
 ...
 */
class behat_mod_glaaster_generator extends behat_generator_base {
    /**
     * Get list of entities for mod_glaaster behat tests.
     *
    ...
    protected function get_tool_id(string $name): int {
        ...
        if (!$id = $DB->get_field('glaaster_types', 'id', ['name' => $name])) {
