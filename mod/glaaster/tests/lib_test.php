...
/**
 * Unit tests for mod_glaaster lib
 *
...
final class lib_test extends advanced_testcase {
    ...
    public function test_lti_glaaster_view(): void {
        ...
        $moodleurl = new moodle_url('/mod/glaaster/view.php', ['id' => $cm->id]);
    ...
    /**
     * Test that the calendar event action is decorated correctly for an admin user.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    public function test_lti_core_calendar_provide_event_action(): void {
        ...
        $actionevent = mod_glaaster_core_calendar_provide_event_action($event, $factory);
    ...
    /**
     * Test that the calendar event action is null when no user is logged in.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    ...
    /**
     * Test that the calendar event action is decorated correctly for a specific enrolled student.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    public function test_lti_core_calendar_provide_event_action_for_user(): void {
        ...
        $actionevent = mod_glaaster_core_calendar_provide_event_action($event, $factory, $student->id);
    ...
    /**
     * Test that the calendar event action is null when the activity is already completed.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    ...
    /**
     * Test that the calendar event action is null when activity is completed and no user is logged in.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    ...
    /**
     * Test that the calendar event action is null when activity is completed for a specific student.
     *
     * @covers ::mod_glaaster_core_calendar_provide_event_action
     */
    public function test_lti_core_calendar_provide_event_action_already_completed_for_user(): void {
        ...
        $actionevent = mod_glaaster_core_calendar_provide_event_action($event, $factory, $student1->id);
    ...
    public function test_content_item_callbacks(): void {
        ...
        $tool3id = $DB->insert_record('glaaster_types', $course1toolrecord);
        $tool4id = $DB->insert_record('glaaster_types', $course2toolrecord);
        $sitetoolrecord->id = $tool1id;
        $sitetoolrecordnonchooser->id = $tool2id;
        $course1toolrecord->id = $tool3id;
        $course2toolrecord->id = $tool4id;

        $defaultmodulecontentitem = new content_item(
            '1',
            'default module content item',
            new string_title('Content item title'),
            new moodle_url(''),
            'icon',
        ...
        $courseitems = glaaster_get_course_content_items($defaultmodulecontentitem, $teacher, $course);
        ...
        $course2items = glaaster_get_course_content_items($defaultmodulecontentitem, $teacher2, $course2);
        ...
        $this->setAdminUser();
        $allitems = glaaster_get_all_content_items($defaultmodulecontentitem);
