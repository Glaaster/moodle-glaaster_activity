...
/**
 * Unit tests for mod_glaaster edit_form
 *
 ...
 * @since      Moodle 4.3
 */
final class mod_glaaster_edit_types_form_test extends advanced_testcase {
    // There are shared helpers for these tests in the helper course_categories_trait.
    use mod_glaaster_course_categories_trait;
    ...
    public function test_set_nested_categories(): void {
        ...
        require_once($CFG->dirroot . '/mod/glaaster/tests/fixtures/test_edit_form.php');
